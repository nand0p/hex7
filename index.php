<?php
	...
	if (isset($_GET['refresh']) && ($_GET['refresh'] != "off")) { echo "<meta http-equiv=refresh content=20>"; }
	echo "
	...
	echo "
		...
		<center><br><p><br>
                ...
                <img src=http://serverfault.com/users/flair/190933.png?theme=hotdog width=95% alt=serverfault title=serverfault>
                </a>
		<p><br><p>
		...
		<td width=40% align=center><b><font size=5>Visitor Identification Number:</font></b><br>
		<font color=red size=+2><b>_-_&nbsp;&nbsp; $visnum &nbsp;&nbsp;_-_</b></font>
		</td><td><img src=xtree.gif width=150></td>
		</td></tr></table>
		</center>$os :: <a href=http://en.wikipedia.org/wiki/SOS>sos</a> at hex7 dot com
		</body>
		</html>
	";
?>
